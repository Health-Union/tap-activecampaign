...
class ActiveCampaign:
            ...
            for record in records:
                ...
                with Transformer() as transformer:
                    try:
                        ...
                        LOGGER.error(
                            "Stream: {}, record: {}".format(stream_name, record)
                        )
                        raise err
    ...
    def sync(
        ...
        ):  # break out of loop when record_count < limit (or not data returned)
            params = {
                "offset": offset,
                "limit": limit,
    ...
    def sync_child_stream(
        self, children, transformed_data, catalog, state, start_date, selected_streams
    ):
        """
                ...
                for record in transformed_data:
                    ...
                    LOGGER.info(
                        "START Sync for Stream: {}, parent_stream: {}, parent_id: {}".format(
                            child_stream_name, self.stream_name, parent_id
                        )
                    )
        ...
        if not data or data is None or data == {} or data.get("result_code", 1) != 1:
            ...
            for record in transformed_data:
                ...
                if hasattr(self, "extra_fields"):
                    ...
                    transformed_data[i] = {**extra_fields_dict, **record}
            ...
            LOGGER.info(
                "Synced Stream: {}, page: {}, {} to {} of total records: {}".format(
                    self.stream_name, page, offset, to_rec, total_records
                )
            )
...
SUB_STREAMS = {"ecommerce_orders": "ecommerce_order_products"}
