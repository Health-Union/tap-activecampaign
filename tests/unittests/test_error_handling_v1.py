...
import requests
from tap_activecampaign import client_v1
...
class TestActiveCampaignErrorhandlingForRequestMethod(unittest.TestCase):
    ...
    """
    @patch("tap_activecampaign.client_v1.ActiveCampaignClientV1.check_api_token")
    ...
    def test_request_with_handling_for_400_exception_handling(self, mocked_request, mock_api_token):
        ...
        """
        _client = client_v1.ActiveCampaignClientV1('dummy_url', 'dummy_token')
